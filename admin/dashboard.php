          ...
          <div class="box box-default">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <ul class="chart-legend clearfix">
                    <li><i class="fa fa-circle-o text-red"></i> Trà sữa</li>
                    <li><i class="fa fa-circle-o text-green"></i> Sữa trà</li>
                    <li><i class="fa fa-circle-o text-yellow"></i> Sã trừa</li>
                    <li><i class="fa fa-circle-o text-aqua"></i> Trữa Sà</li>
                    <li><i class="fa fa-circle-o text-light-blue"></i> Hmmmm</li>
                    <li><i class="fa fa-circle-o text-gray"></i> Ư ư</li>
                  </ul>
                </div>
                <!-- /.col -->
              </div>
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#">Huế <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 4%</span></a>
                </li>
                <li><a href="#">Hồ Chí Minh
