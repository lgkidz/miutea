...
<form role="form" id="dangnhapForm" name="dangnhapForm" action="includes/user_login.php" method="post">
<h3>ĐĂNG NHẬP</h3>
...
<form role="form" id="dangkyForm" name="dangkyForm" action="includes/user_regis.php" method="post">
<h3>ĐĂNG KÝ</h3>
