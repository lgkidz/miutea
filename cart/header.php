 ...
 <nav class="navbar navbar-default">
  <div class="container-fluid"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="../">MiuTea</a> </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	  ...
	  <?php
		...
		?>
        <li><a href="index.php"><span class="glyphicon glyphicon-shopping-cart"><span class="badge"><?php echo isset($_SESSION["items"])? sizeof($_SESSION["items"]):0?></span></span></a> </li>
      </ul>
